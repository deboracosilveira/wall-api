...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'wall-api.herokuapp.com', protocol: 'https' }

  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address:              'smtp.gmail.com',
    port:                 587,
    domain:               'wall-api.herokuapp.com',
    user_name:            'wallapp.noreply@gmail.com',
    password:             'fuzkcdehqiszdfxi',
